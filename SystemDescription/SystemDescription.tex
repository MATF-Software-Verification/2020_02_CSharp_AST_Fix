...
\begin{document}
	...
	\abstract{
		...
		\label{subsec:prazne}
		Poslednji primer prikazuje ukljanjanje praznih naredbi. Kad god se u kodu naiđe na praznu naredbu, ista se jednostavno eliminiše. 
