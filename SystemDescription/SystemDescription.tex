...
\begin{document}
	...
	\abstract{
		...
		\par Slično kao u prethodnom primeru, postoji klasa koja implementira čeker - \textit{SwapVarWithExplicitTypeChecker}, i klasa koja implementira metod koji posećuje čvorove - \textit{RewriterVarToExplicitType} (Slika \ref{fig:RewriterVarToType}). U ovoj transformaciji, neophodno je bilo koristiti semantički model.
		% TODO ANA
